                            ...
                            <td class="px-4 py-2 space-x-2">
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('admin.user.destroy', $user->id) }}" method="POST"
                                        onsubmit="return confirm('Yakin hapus?')" class="w-full">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
    ...
    <div id="modal-edit-user" class="fixed inset-0 flex items-center justify-center hidden z-50">
        ...
        <div class="relative bg-white p-6 rounded-lg shadow-lg w-full max-w-md z-10">
            ...
            <form id="edit-user-form" method="POST">
                ...
                <div class="mb-3">
                    <label class="block mb-1 font-medium">Nama</label>
                    <input type="text" name="name" id="edit-user-name" class="w-full border rounded px-3 py-2"
                        required>
                </div>
                <div class="mb-3">
                    <label class="block mb-1 font-medium">Email</label>
                    <input type="email" name="email" id="edit-user-email" class="w-full border rounded px-3 py-2"
                        required>
                </div>
                <div class="mb-3">
                    <label class="block mb-1 font-medium">Role</label>
