...
<div class="p-6 overflow">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-sky-400 p-4 rounded shadow transform transition duration-300 hover:scale-110">
            <p class="text-sm text-white">Total Sales</p>
            <h2 class="text-xl font-bold text-white">Rp {{ number_format($totalPenjualan ?? 0, 0, ',', '.') }}</h2>
            <p class="text-xs text-white mt-1">↑ +12.5% from last month</p>
        </div>
        <div class="bg-sky-400 p-4 rounded shadow transform transition duration-300 hover:scale-110">
            <p class="text-sm text-white">Total Purchase</p>
            <h2 class="text-xl font-bold text-white">Rp {{ number_format($totalPembelian ?? 0, 0, ',', '.') }}</h2>
            <p class="text-xs text-white mt-1">↓ -3.2% from last month</p>
        </div>
        <div class="bg-sky-400 p-4 rounded shadow transform transition duration-300 hover:scale-110">
            <p class="text-sm text-white">Total Products</p>
            <h2 class="text-xl font-bold text-white">{{ $totalProduk }}</h2>
            <p class="text-xs text-white mt-1">+8.1% from last month</p>
        </div>
        <div class="bg-sky-400 p-4 rounded shadow transform transition duration-300 hover:scale-110">
            <p class="text-sm text-white">Active Users</p>
            <h2 class="text-xl font-bold text-white">{{ $totalPengguna }}</h2>
            <p class="text-xs text-white mt-1">+4.5% from last month</p>
        </div>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-sky-400 p-6 rounded shadow">
            ...
            <div class="h-48 flex items-center justify-center bg-sky-400 text-sm border-2 border-dashed rounded">
