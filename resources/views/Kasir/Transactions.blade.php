    ...
    <div class="grid grid-cols-3 gap-6">
                    ...
                    <tbody id="product-table">
                        @foreach ($products as $product)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2 text-green-600">Rp {{ number_format($product->price, 0, ',', '.') }}
                                </td>
                                <td class="px-4 py-2">
                                    <button
                                        class="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 add-to-cart"
        ...
        <div>
            <div class="bg-white p-4 rounded shadow sticky top-6">
                ...
                <button id="save-transaction"
                    class="mt-4 w-full bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Simpan
                    Transaksi</button>
            </div>
        </div>
    </div>
...
@section('script')
    <script>
        ...
        document.getElementById('save-transaction').addEventListener('click', function() {
            ...
            console.log("Cart akan dikirim: ", cart);
            ...
            fetch('/kasir/transaksi', {
                ...
                .then(async response => {
                    ...
                    try {
                        ...
                        alert('Terjadi kesalahan. Coba login ulang atau cek console.');
                    }
                })
                .catch(error => {
